...
def config_from_env() -> TushareUpdateConfig | None:
    ...
    return TushareUpdateConfig(
        ...
        max_stocks=_env_int("TUSHARE_MAX_STOCKS", 20),
        max_futures=_env_int("TUSHARE_MAX_FUTURES", 5),
        max_minute_symbols=_env_int("TUSHARE_MAX_MINUTE_SYMBOLS", 2),
